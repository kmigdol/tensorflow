...
/* static */ constexpr const char* const AssertPrevDatasetOp::kInputDataset;
/* static */ constexpr char AssertPrevDatasetOp::kDatasetType[];
/* static */ constexpr const char* const AssertPrevDatasetOp::kTransformations;
/* static */ constexpr const char* const AssertPrevDatasetOp::kOutputTypes;
/* static */ constexpr const char* const AssertPrevDatasetOp::kOutputShapes;

namespace {

// Parses `transformation` to construct a `NameAttrList` with a transformation
// op name and attr name-value pairs.
StatusOr<NameAttrList> GetAssertions(const tstring& transformation) {
  NameAttrList assertions;
  bool success =
      proto2::TextFormat::ParseFromString(transformation, &assertions);
  if (!success) {
...
// Checks `dataset`'s op name and attrs against those in `assertions`.
